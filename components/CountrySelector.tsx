    ...
    <div className="flex flex-col md:flex-row gap-4 items-center">
      <div className="relative" ref={dropdownRef}>
        <button
          ...
          className="flex items-center gap-3 bg-white/5 border border-white/10 rounded-xl px-5 py-3 hover:border-white/20 hover:bg-white/10 transition-all w-full md:w-[260px] group"
        >
